  ...
  <body>
        ...
        <ul>
          ...
          <li><a class="activepg" class="dropdown">Recipes</a>
            <ul class="dropdown--menu">
              <li><a class="activepg" class="link" href="pancake.php">Pancakes</a></li>
          ...
          <li><a class="dropdown">SignUp/Login</a>
            <ul class="dropdown--menu">
              <li><form action="signup.php" method="POST">
                    <p>SignUp</p>
                    <input required type="text" name="first" placeholder="Firstname"><br>
    ...
    <article class="recipe">
      ...
      foreach ($xml->children() as $recipe) {
        ...
        <div class="flexbox">
          <div id="picpancake" class="poster" title="Pancakes with fruit and berries"></div>
          <div class="textpos">
